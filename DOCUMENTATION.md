...
This document is designed as the master technical-functional reference for the current repository state. Update it whenever adding new domains, APIs, major schemas, or operational workflows.
